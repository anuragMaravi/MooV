 ...
 */
public class FragmentUpcomingMovies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new JSONTask().execute("http://api.themoviedb.org/3/movie/upcoming?api_key=0744794205a0d39eef72cad8722d4fba");
        return rootview;
    ...
    public class JSONTask extends AsyncTask<String, String, List<ListItem>> {
        ...
        protected void onPostExecute(List<ListItem> result) {
            ...
            adapter = new AdapterUpcomingMovies((ArrayList<ListItem>) movieModelList,getContext());
